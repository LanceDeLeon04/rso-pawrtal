...
import {
  checkVenueAvailability as sharedCheckVenueAvailability,
  coreWindow, bufferedWindow, windowsOverlap, toMinutes,
  GATE_OPEN_MIN, GATE_CLOSE_MIN, INGRESS_EGRESS_BUFFER_MIN,
...
export default function SubmissionBin() {
  ...
  // Venue-availability logic (gate hours, ingress/egress buffers,
  // blocked-date and conflict checks) now lives in
  // ../lib/venueAvailability so the public Curricular Activity apply
  // form can show the same notices. Imported above.
  ...
  async function checkVenueAvailability(venueId, date, startTime, endTime, additionalIngressTime, additionalEgressTime) {
    return sharedCheckVenueAvailability(supabase, venueId, date, startTime, endTime, additionalIngressTime, additionalEgressTime)
  }
