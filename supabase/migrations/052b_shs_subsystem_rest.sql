-- ============================================================
-- 052b: SHS Sub-System (continued) — run AFTER 052a has been
-- COMMITTED. New enum values ('sdao_shs', 'shs_principal', etc.)
-- cannot be referenced in the same transaction they were added
-- in, so this half was split out.
-- ============================================================
